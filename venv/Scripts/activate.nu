...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'F:\MINTIC\ciclo 3\Sprint 3\template_sprint_3_nc\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'F:\MINTIC\ciclo 3\Sprint 3\template_sprint_3_nc\venv\Scripts\deactivate.nu'
